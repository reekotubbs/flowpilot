...
class CarState(CarStateBase):
  ...
  def update(self, pt_cp, cam_cp, loopback_cp):
    ...
    ret.steeringAngleDeg = pt_cp.vl["PSCMSteeringAngle"]["SteeringWheelAngle"] + 1.9
  ...
  def get_can_parser(CP):
    signals = [
      ...
      ("EngineCoolantTemp", "ECMEngineCoolantTemp"),
      ("EngineRPM", "ECMEngineStatus"),
      ("EPBClosed", "EPBStatus"),
      ("LateralAcceleration", "EBCMVehicleDynamic"),
    ...
    if CP.carFingerprint in [CAR.VOLT, CAR.VOLT_NR]:
      signals += [
