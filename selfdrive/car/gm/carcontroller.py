# hard-forked from https://github.com/commaai/openpilot/tree/05b37552f3a38f914af41f44ccc7c633ad152a15/selfdrive/car/gm/carcontroller.py
...
class CarController():
  ...
  # from opgm-dev add enabled
  def update(self, c, enabled, CS, frame, actuators, hud_v_cruise, hud_show_lanes, hud_show_car, hud_alert):
  #
    ...
    # from opgm-dev indent original code
